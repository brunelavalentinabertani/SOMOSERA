  ...
  return (
    <main className="min-h-screen bg-era-white text-era-black">
      ...
      <section className="border-t border-era-line">
        <div className="mx-auto grid max-w-[1420px] grid-cols-1 py-6 lg:grid-cols-[380px_1fr] xl:grid-cols-[440px_1fr] xl:py-8">
          <div className="flex min-h-[360px] flex-col justify-center px-5 sm:px-8 lg:min-h-[480px] lg:px-10 xl:min-h-[560px] xl:px-12">
            <h1 className="text-[56px] font-black leading-[0.92] tracking-[-0.05em] sm:text-[70px] xl:text-[82px]">
          ...
          <div className="grid h-[380px] grid-cols-3 grid-rows-2 gap-1 sm:h-[460px] sm:grid-cols-4 lg:h-[520px] xl:h-[560px]">
      ...
      <section className="border-y border-era-line">
        <div className="mx-auto grid max-w-[1420px] grid-cols-1 gap-9 px-5 py-10 sm:px-8 lg:px-12 xl:grid-cols-[280px_1fr_300px] xl:gap-10 xl:py-12">
          ...
          <Link
            href={instagramHref}
            target="_blank"
            className="flex min-h-[150px] flex-col justify-between rounded-[6px] border border-era-line bg-white p-6 transition hover:border-era-black"
          >
      ...
      <section className="border-b border-era-line">
        <div className="mx-auto grid max-w-[1420px] grid-cols-1 px-5 py-10 sm:px-8 lg:px-12 xl:grid-cols-[1fr_390px]">
          ...
          <div className="flex min-h-[360px] flex-col justify-center pt-9 xl:min-h-[380px] xl:pl-12 xl:pt-0">
            <h2 className="text-[24px] font-black">
